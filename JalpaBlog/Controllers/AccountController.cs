...
namespace JalpaBlog.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // await UserManager.SendEmailAsync(user.Id, "Subject", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
        ...
        //added support for resending the email confirmation 
        [HttpGet]
        [AllowAnonymous]
        ...
        //Resending email conf ends here
